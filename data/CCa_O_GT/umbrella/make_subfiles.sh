...
do
	...
	echo "cd /nobackup1c/users/anggao/BasePair/CCa_O_GT/umbrella/$i"  >> sub$i.sh
	echo "/home/anggao/Gromacs5/bin/gmx grompp -f umbrella.mdp -p topolCCaspce.top -n index.ndx -c equil_$i.gro -o md.tpr -maxwarn 2" >> sub$i.sh
