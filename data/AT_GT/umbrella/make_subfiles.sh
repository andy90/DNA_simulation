...
do
	...
	echo "cd /nobackup1c/users/anggao/BasePair/AT_GT/umbrella/$i"  >> sub$i.sh
	echo "/home/anggao/Gromacs5/bin/gmx grompp -f umbrella.mdp -p topolATspce.top -n index.ndx -c equil_$i.gro -o md.tpr -maxwarn 2" >> sub$i.sh
