...
df_AB <- readRDS(paste(filepath2, "df_PO4Ca", sep = ""))
a <- read_table(file = paste(filepath, "PO4Cacharges.txt", sep = ""), col_names = FALSE)
...
saveRDS(df_LMF_intermediate, file = paste(filepath, "df_PO4Ca_LMF_inter", sep = ""))
