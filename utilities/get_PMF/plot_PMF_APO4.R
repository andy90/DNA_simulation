...
library(tidyverse)
library(here)
full <- readRDS(file = here("data/APO4/umbrella/10blocks/df_APO4_meanstd_10blocks"))


GT <- readRDS(file = here("data/APO4_GT/umbrella/10blocks/df_APO4_GT_meanstd_10blocks"))
...
v_LMF_inter <- readRDS(here("utilities/get_PMF/df_APO4_LMF_inter"))
...
p <- p + xlim(0.2, 0.9)
p
ggsave(here("utilities/get_PMF/APO4_LMF_PMF.pdf"))
