...
df_AB <- readRDS(paste(filepath2, "df_GC", sep = ""))
a <- read_table(file = paste(filepath, "GCcharges.txt", sep = ""), col_names = FALSE)
...
saveRDS(df_LMF_intermediate, file = paste(filepath, "df_CG_LMF_inter", sep = ""))
