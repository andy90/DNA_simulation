...
r_N3 <- as.numeric(C_init[C_init$V2 == 'O2', 4:6])
r_C6 <- as.numeric(C_init[C_init$V2 == 'C5', 4:6])
r_N3C6 <- r_N3 - r_C6
lengthvec(r_N3C6)
...
rC5 <- C_xyz_inter_3[,C_init$V2 ==  'C6']
...
saveRDS(df_C_final, file = paste(filepath, "df_C_new", sep = ""))

write_to_gro(paste(filepath, "C_new.gro", sep = ""), df_C_final)
