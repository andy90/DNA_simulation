...
write_to_gro <- function(file_name, df_out){
  write(x = "Ang Gao PO4", file = file_name, append = FALSE)
...
write_to_gro(paste(filepath, "PO4.gro", sep = ""), df_PO4_final)
saveRDS(df_PO4_final, file = paste(filepath, "df_PO4", sep = ""))
